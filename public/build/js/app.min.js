...
!function(n){var t=n(window),o=t.height();t.resize(function(){o=t.height()}),n.fn.parallax=function(e,u,i){function r(){var i=t.scrollTop();h.each(function(){var t=n(this),r=t.offset().top,t=c(t);i>r+t||r>i+o||h.css("backgroundPosition",e+" "+Math.round((f-i)*u)+"px")})}var c,f,h=n(this);h.each(function(){f=h.offset().top}),c=i?function(n){return n.outerHeight(!0)}:function(n){return n.height()},(1>arguments.length||null===e)&&(e="50%"),(2>arguments.length||null===u)&&(u=.1),(3>arguments.length||null===i)&&(i=!0),t.scroll(r).resize(function(){h.each(function(){f=h.offset().top}),r()}),r()}}(jQuery);
...
!function(){var e=function(){$(".send-email").click(function(e){e.preventDefault(),n();var r={name:$("#name").val(),email:$("#email").val(),message:$("#message").val()};a(r)||($.post("/send",r),$("#response").addClass("sent-alert").html("Thank you, I will replay as soon as I can"),s())})},a=function(e){for(var a in e)if(""==e[a])return"message"==a?$("#message").parent().addClass("has-error has-feedback"):$("#"+a).parent().addClass("has-error has-feedback"),!0;return!1},s=function(){$("#name, #email, #message").val(""),n(),setTimeout(function(){$("#response").empty().removeClass("sent-alert")},1e4)},n=function(){$(".form-group").removeClass("has-error has-feedback")};e()}();