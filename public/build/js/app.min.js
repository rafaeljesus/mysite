...
$(function(){var e=function(){$(".send-email").click(function(e){e.preventDefault();var n={name:$("#name").val(),email:$("#email").val(),message:$("#message").val()};$.post("/send",n),$("#response").addClass("sent-alert").html("Thank you, I will replay as soon as I can"),a()})},a=function(){$("#name, #email, #message").val(""),setTimeout(function(){$("#response").empty().removeClass("sent-alert")},1e4)};e()});